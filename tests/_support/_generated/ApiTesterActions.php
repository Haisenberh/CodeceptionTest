<?php  //[STAMP] e6128a15d90051adca42cb00f7680888
...
trait ApiTesterActions
{
     ...
     *
     *
     * @see \Helper\Api::authorizeToApp()
     */
    public function authorizeToApp($I) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('authorizeToApp', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\Api::createNewCookie()
     */
    public function createNewCookie($I) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('createNewCookie', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\Api::getExperienceIdByLegend()
     */
    public function getExperienceIdByLegend($I, $legend) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getExperienceIdByLegend', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\Api::getCurrencyIdByName()
     */
    public function getCurrencyIdByName($I, $currency_name) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getCurrencyIdByName', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\Api::getCarrierIdByName()
     */
    public function getCarrierIdByName($I, $carrier_name) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getCarrierIdByName', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\Api::getNationalityIdByName()
     */
    public function getNationalityIdByName($I, $nationality) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getNationalityIdByName', func_get_args()));
    }
